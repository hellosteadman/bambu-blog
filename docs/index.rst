...
copy, and `Bambu
Attachments <https://github.com/iamsteadman/bambu-attachments>`_ to
handle uploading images and other media.

It's grown a little since then, and now supports either the
`MarkItUp <https://bitbucket.org/carljm/django-markitup/src>`_ or
`TinyMCE <https://github.com/aljosa/django-tinymce>`_ editors (just
